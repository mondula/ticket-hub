    ...
    if ($post_id && get_post($post_id)) {
        ...
        if (get_post_status($post_id) != 'private') {
            ...
            <div class="ticket-details">
                <a onclick="history.back()" class="back-to-archive">
            ...
            if (current_user_can('comment_tickets')) {
                echo '<hr>';
...
function display_comment_with_replies($comment, $depth = 0) {
    ...
    echo '<div class="comment-author"><p><b>' . esc_html($comment->comment_author) . '</b></p></div>';
