...
add_shortcode('th_profile', function () {
    ...
    if (!is_user_logged_in()) {
        ...
        $args = array(
            ...
            'label_username' => __('Username', TEXT_DOMAIN),
            'label_password' => __('Password', TEXT_DOMAIN),
            'label_remember' => __('Remember Me', TEXT_DOMAIN),
            'label_log_in'   => __('Log In', TEXT_DOMAIN),
