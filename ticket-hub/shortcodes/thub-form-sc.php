...
add_shortcode('thub_form', function () {
    ...
    if (!$ticket_form_enqueue) {
        wp_enqueue_style('thub-form-style', PLUGIN_ROOT . 'css/thub-form.css', array(), '', 'all');
        wp_enqueue_script('thub-form-script', PLUGIN_ROOT . 'js/thub-form.js', array('jquery'), '', true);
